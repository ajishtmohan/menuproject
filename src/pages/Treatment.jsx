...
function Doctor() {
  ...
  console.log(params.treatment);

  useEffect(
    function () {
      setTreatment(params.treatment);
    },
    [params],
  );

  async function fetchTreatment(treatment) {
    try {
  ...
  return <section className='pt-100'>{treatmentName?.treatName}</section>;
  ...
  //             </p>
  //             <h1 className='mb-4 '>
  //               <span className='text-earth-100 font-heading text-6xl leading-12'>
  //                 Dr. Nalini Marath
  //               </span>
  //             </h1>
